...
export const createJob = (namespace: string, data: V1Job, k8sApi: k8s.BatchV1Api) =>
  updateOrCreate(
...
export const createDaemonSet = (namespace: string, data: V1DaemonSet, k8sApi: k8s.AppsV1Api) =>
  updateOrCreate(
